...
#define USBD_HID1_IN_REPORT_NUM                   2
...
#define USBD_HID1_IN_REPORT_MAX_SZ                9
...
#define USBD_HID1_USER_REPORT_DESCRIPTOR_SIZE     152
